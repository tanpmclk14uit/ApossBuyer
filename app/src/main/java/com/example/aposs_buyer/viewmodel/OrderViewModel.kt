...
class OrderViewModel @Inject constructor() : ViewModel() {
    ...
    fun loadPendingOrder(): ArrayList<Order> {
        ...
        sampleBillingItems.add(
            OrderBillingItem(
                ...
                50000,
                1,
                "Color: Blue, Size: 30 Color: Blue, Size: 30 Color: Blue, Size: 30 Color: Blue, Size: 30"
            )
        )
        sampleBillingItems.add(
            OrderBillingItem(
    ...
    fun loadConfirmedOrder(): ArrayList<Order> {
        ...
        samplePendingOrders.add(
            Order(
                1, Date(), OrderStatus.Confirmed, "Mr Pham Minh Tan, 0343027600, 696 Hang Bai khu pho 6, Phuong linh trung, Thu Duc, Ho Chi Minh", sampleBillingItems, 140000
            )
        )
        samplePendingOrders.add(
            Order(
                2, Date(), OrderStatus.Confirmed, "Mr Pham Minh Tan, 0343025877, 696 Hang Bai khu pho 1, Phuong linh trung, Thu Duc, Ho Chi Minh", sampleBillingItems2, 80000
            )
        )
        return samplePendingOrders
    }
